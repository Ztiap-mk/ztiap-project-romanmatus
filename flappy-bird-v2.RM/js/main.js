...
window.addEventListener('load', function() {
	//obrazovky
	Img.ins.src = "obrazovky/instrukcie.png";
	Img.menu.src = "obrazovky/uvodna.png";
	Img.gameover.src = "obrazovky/gameover.png";
	Img.map.src = "img/bg.png";
	Img.fg.src = "img/backgorund1.png";
	//core
	Img.bird.src = "img/sprite.png";
	Img.coin.src = "img/coin.png";
	Img.pipeUp.src = "img/pipe.png";
	Img.pipeDwn.src = "img/pipe.png";
	//btns
	Img.buttonPlay.src = "buttons/hraj.png";
	Img.buttonInstrukcie.src = "buttons/instrukcie.png";
	Img.buttonBasic.src = "buttons/basic.png";
	//icons
	Img.menuicon.src = "icons/home.png";
	Img.soundicon.src = "icons/zvuk.png";
	Img.soundmuteicon.src = "icons/mute.png";
